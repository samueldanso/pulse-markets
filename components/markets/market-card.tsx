...
const TOPIC_ICONS: Record<string, string> = {
  ...
  "Viral Tweet": "/images/viral-tweet.svg",
};
...
export function MarketCard(props: MarketCardProps) {
  ...
  return (
    <div
      className="group flex h-[320px] cursor-pointer flex-col overflow-hidden rounded-xl border border-white/[0.08] bg-white/[0.03] transition-all hover:border-white/[0.15] hover:bg-white/[0.05]"
      ...
      <div className="px-4 pb-4">
        {isClosed ? (
          ...
          <div className="flex items-center gap-3">
            ...
            <span className="font-mono text-xs text-pulse-gray">
              {countdown}
            </span>
          </div>
        )}
