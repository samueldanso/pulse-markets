...
### 4. On-chain proof (8004scan)

- **8004scan** is the explorer for ERC-8004 agents on Base: [https://www.8004scan.io](https://www.8004scan.io).
- Our registered agent: **[https://www.8004scan.io/agents/base/2373](https://www.8004scan.io/agents/base/2373)**.
- Every settlement API response includes an `agent` field with `registryUrl` pointing to this page, so anyone can click through to see on-chain identity and reputation.
